...
// Query per ottenere i prodotti per la sezione Outlet
$query = "SELECT id, nome, descrizione, prezzo, immagine, sconto FROM outlet";
...
<body>
    ...
    <main>
        <div class="outlet-container" id="outlet-container">
